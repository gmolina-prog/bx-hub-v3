  ...
  return (
    <div className="p-6 max-w-[1600px] mx-auto">
      <div className="bg-gradient-to-br from-zinc-800 to-zinc-900 rounded-2xl p-6 mb-6 text-white">
        ...
        <h1 className="text-2xl font-bold mb-1">⚙️ Configurações</h1>
      ...
      <div className="bg-white border border-zinc-200 rounded-xl p-12 text-center">
        ...
        <div className="text-sm font-bold text-zinc-700">Configurações — Em breve</div>
